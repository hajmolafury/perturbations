...
if sys.argv[1]=='0':
	# GPU1
	# os.system("CUDA_VISIBLE_DEVICES=0 python master.py --learning_rate 1 --alpha 0.8 --n_hl 3 --hl_size 300")
	# os.system("CUDA_VISIBLE_DEVICES=0 python master.py --learning_rate 3 --alpha 0.8 --n_hl 3 --hl_size 300")
    ...
    # os.system("CUDA_VISIBLE_DEVICES=0 python master.py --learning_rate 1 --alpha 1 --n_hl 3 --hl_size 300")

    os.system("CUDA_VISIBLE_DEVICES=0 python master.py --learning_rate 1 --alpha 0.7 --n_hl 1 --hl_size 300")
    os.system("CUDA_VISIBLE_DEVICES=0 python master.py --learning_rate 3 --alpha 0.7 --n_hl 1 --hl_size 300")
    os.system("CUDA_VISIBLE_DEVICES=0 python master.py --learning_rate 1 --alpha 0.7 --n_hl 2 --hl_size 300")
    os.system("CUDA_VISIBLE_DEVICES=0 python master.py --learning_rate 3 --alpha 0.7 --n_hl 2 --hl_size 300")

if sys.argv[1]=='1':
	# GPU2
	# os.system("CUDA_VISIBLE_DEVICES=1 python master.py --learning_rate 1 --alpha 0.8 --n_hl 7 --hl_size 300")
	# os.system("CUDA_VISIBLE_DEVICES=1 python master.py --learning_rate 0.03 --alpha 0 --n_hl 1 --hl_size 300")
    # os.system("CUDA_VISIBLE_DEVICES=1 python master.py --learning_rate 1 --alpha 1 --n_hl 4 --hl_size 300")
    # os.system("CUDA_VISIBLE_DEVICES=1 python master.py --learning_rate 1 --alpha 1 --n_hl 5 --hl_size 300")
    # os.system("CUDA_VISIBLE_DEVICES=1 python master.py --learning_rate 1 --alpha 0.7 --n_hl 6 --hl_size 300")
    # os.system("CUDA_VISIBLE_DEVICES=1 python master.py --learning_rate 3 --alpha 0.7 --n_hl 6 --hl_size 300")
    ...
    os.system("CUDA_VISIBLE_DEVICES=1 python master.py --learning_rate 3 --alpha 0.7 --n_hl 7 --hl_size 300")
...
if sys.argv[1]=='2':
    ...
    # os.system("CUDA_VISIBLE_DEVICES=2 python master.py --learning_rate 3 --alpha 0.7 --n_hl 8 --hl_size 300")
    ...
    os.system("CUDA_VISIBLE_DEVICES=2 python master.py --learning_rate 1 --alpha 0.7 --n_hl 3 --hl_size 300")
    os.system("CUDA_VISIBLE_DEVICES=2 python master.py --learning_rate 3 --alpha 0.7 --n_hl 3 --hl_size 300")
    os.system("CUDA_VISIBLE_DEVICES=2 python master.py --learning_rate 1 --alpha 1 --n_hl 4 --hl_size 300")
    #

	# GPU5
	# os.system("CUDA_VISIBLE_DEVICES=2 python master.py --learning_rate 3 --alpha 0.8 --n_hl 3 --hl_size 300")
	# os.system("CUDA_VISIBLE_DEVICES=2 python master.py --learning_rate 1 --alpha 0.8 --n_hl 3 --hl_size 300")
